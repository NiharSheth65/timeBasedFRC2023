...
//   private CANVictorSpx lowerintake;//
...
//   pid controllers 
  ...
  private SparkMaxPIDController lowerJawPidController; 
  ...
  public void robotInit() {
    ...
    // lowerintake = new CANVictorSpx(var.lowerIntakeMortorID, MotorType.kBrushless)
    ...
    lowerJawPidController = jawLowerMotor.getPIDController(); 
    lowerJawPidController.setP(var.lower_jaw_kp);
    lowerJawPidController.setI(var.lower_jaw_ki);
    lowerJawPidController.setD(var.lower_jaw_kd);   
    ...
    switch (m_autoSelected) {
      ...
      default:
        ...
        while(distanceError > 0){
            ...
            distanceError = setDistance - distanceTravelled;
            SmartDashboard.putNumber("auto distance travelled", distanceTravelled); 
            SmartDashboard.putNumber("auto erorr", distanceError); 
  ...
  public void teleopPeriodic() {
    ...
    double jawLowerAngle = jawLowerEncoderPosition; //50 
    double jawUpperAngle = jawUpperEncoderPosition; // 7.5
    ...
    if (buttonA) {
      ...
      Jaw_Lower_Setpoint = -147;
      Jaw_Upper_Setpoint = -75;
    }

    else if(buttonY) {
        Jaw_Lower_Setpoint = -94;
    }
    ...
    // lower_jaw_pid_controller.setTolerance(10, 10);
    
    if(Math.abs(Jaw_Lower_Setpoint - jawLowerAngle) > 2){
      // jawLowerMotor.set(lower_jaw_pid_controller.calculate(jawLowerAngle, Jaw_Lower_Setpoint));
    }
