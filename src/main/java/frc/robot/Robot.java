...
public class Robot extends TimedRobot {
  ...
  public void teleopPeriodic() {
    ...
    if (buttonLB) {
      ...
      if(intakeState == false){
        ...
        winchMechanismSpeed = var.winchSpeed; 
      }
      else{
    ...
    if(limitStateFront == false){
      ...
      winchMechanismSpeed = 0;
    }

    if(limitStateBack == false){
    ...
    winchMotor.set(winchMechanismSpeed);
  ...
  public void autoMiddle(){
    ...
    if(autonStage == 0){
      ...
      setUpperMode = 0; 
      distanceToTravel = 45;// 2.26 = 1 foot abou 45 for 20ft  
