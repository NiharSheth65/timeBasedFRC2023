...
public class variables {
    ...
    double outtakeUpperSpeed = 0.5;
    double autoOuttakeUpperSpeed = 0.30;
    double idleInSpeed = 0.075; 
    ...
    // PID one 
    // find gyro error example 10 degrees 
    // find optimal speed (50%)

    // autonomous speed
    double autonomousSpeedFast = 1500;
    double distanceToClearCommunityOnTheSide = -52;
    double distanceToDock = -15;

    // double balanceing PID cONTRANTS 
    double balancing_kp = 0.0003; 
    double balancing_ki = 0.0001; 
    double balancing_kd = 0; 

    // double auto max sped 
    double autoMaxSpeed = 600; 
